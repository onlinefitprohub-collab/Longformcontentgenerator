...
export const STAGES: Omit<Stage, "complete">[] = [
  ...
  { id: 1, label: "Stage 1", title: "Coach Background",        accent: "#3B82F6" },
  { id: 2, label: "Stage 2", title: "Transformation Stories",  accent: "#8B5CF6" },
  { id: 3, label: "Stage 3", title: "Training Pillars",        accent: "#EF4444" },
  { id: 4, label: "Stage 4", title: "Audience & Questions",    accent: "#F59E0B" },
  { id: 5, label: "Stage 5", title: "Myths & Contrarian Views",accent: "#EC4899" },
  { id: 6, label: "Stage 6", title: "Programmes & Frameworks", accent: "#06B6D4" },
